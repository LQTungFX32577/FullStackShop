...
export type InputProps = Omit<InputHTMLAttributes<HTMLInputElement> & ClassAttributes<HTMLInputElement>, "ref">;
 ...
 */
export declare function AutoNumericInput({ inputProps, autoNumericOptions, valueState, }: {
