 ...
 */
export function AutoNumericComponent({ element, refKey, props, autoNumericOptions, state, }) {
    ...
    useEffect(() => {
        ...
        autoNumeric.current = new AutoNumeric(htmlElement.current, autoNumericOptions ?? {});
    }, [htmlElement.current]);
    if (state !== undefined) {
        useEffect(() => {
            if (autoNumeric.current === null) {
